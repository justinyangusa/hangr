...
<body>
	<form action="calendar.php" method="POST" name="form">
		<h2>Availability</h2>
		<br/>
		Start Time: <input type="text" id="startdate" class="datepicker" data-format="YYYY-MM-DD HH:mm" data-template="MM / DD  / YYYY   HH : mm" name="startdate" value="2014-07-12 01:50">
		<br/>
		End Time: <input type="text" id="enddate" class="datepicker" data-format="YYYY-MM-DD HH:mm" data-template="MM / DD  / YYYY   HH : mm" name="enddate" value="2014-07-12 02:20">
		<br/>
	...
	<form action="calendar.php" method="POST" name="something">
		<h2>Invite</h2>
		<br/>
	...
	<?php
		...
		while($row = mysqli_fetch_array($theres))
		{
			...
			$sentMsg = "<p ".$background.">Start Time: ".$row['start']." | End Time: ".$row['end']." | Invitee: ".$row['tod']." | Message: ".$row['notes']." | Response: ".$reply." | ".$delete."</p>";
			echo $sentMsg;
		}
	?>
	...
	<?php
		...
		while($row = mysqli_fetch_array($theres))
		{
			...
			$sentMsg = "<p ".$background.">Start Time: ".$row['start']." | End Time: ".$row['end']." | From: ".$row['fro']." | Message: ".$row['notes']." | Response: ".$yesorno."</p>";
			echo $sentMsg;
		}
	?>
